...
public class CustomImportOrderCheck extends AbstractCheck {
    ...
    private void finishImportList() {
        ...
        for (ImportDetails importObject : importToGroupList) {
            ...
            if (importGroup.equals(currentGroup)) {
                if (isSeparatedByExtraLine(previousImportObjectFromCurrentGroup, importObject)) {
     ...
     */
    private boolean isSeparatedByExtraLine(ImportDetails previousImportObject,
                                           ImportDetails importObject) {
     ...
     * @return count of empty lines between given parameters, inclusive,
    ...
    private int getCountOfEmptyLinesBetween(int fromLineNo, int toLineNo) {
        ...
        // [fromLineNo - 1, toLineNo - 1 + 1)
        for (int i = fromLineNo - 1; i < toLineNo; i++) {
